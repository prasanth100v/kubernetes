...
* Review the application logs with 𝙠𝙪𝙗𝙚𝙘𝙩𝙡 𝙡𝙤𝙜𝙨 (and --𝙥𝙧𝙚𝙫𝙞𝙤𝙪𝙨 if needed).
* Verify the 𝙨𝙩𝙖𝙧𝙩𝙪𝙥 𝙘𝙤𝙢𝙢𝙖𝙣𝙙, 𝙚𝙣𝙫𝙞𝙧𝙤𝙣𝙢𝙚𝙣𝙩 𝙫𝙖𝙧𝙞𝙖𝙗𝙡𝙚𝙨, 𝘾𝙤𝙣𝙛𝙞𝙜𝙈𝙖𝙥𝙨, and 𝙎𝙚𝙘𝙧𝙚𝙩𝙨.
* Check 𝙙𝙖𝙩𝙖𝙗𝙖𝙨𝙚 and 𝙚𝙭𝙩𝙚𝙧𝙣𝙖𝙡 𝙨𝙚𝙧𝙫𝙞𝙘𝙚 𝙘𝙤𝙣𝙣𝙚𝙘𝙩𝙞𝙫𝙞𝙩𝙮.
* Inspect 𝘾𝙋𝙐 and 𝙢𝙚𝙢𝙤𝙧𝙮 usage, especially for 𝙊𝙊𝙈𝙆𝙞𝙡𝙡𝙚𝙙.
* Validate 𝙡𝙞𝙫𝙚𝙣𝙚𝙨𝙨 and 𝙨𝙩𝙖𝙧𝙩𝙪𝙥 𝙥𝙧𝙤𝙗𝙚 𝙘𝙤𝙣𝙛𝙞𝙜𝙪𝙧𝙖𝙩𝙞𝙤𝙣.
* Verify 𝙫𝙤𝙡𝙪𝙢𝙚 𝙢𝙤𝙪𝙣𝙩𝙨, 𝙛𝙞𝙡𝙚 𝙥𝙚𝙧𝙢𝙞𝙨𝙨𝙞𝙤𝙣𝙨, and 𝙣𝙤𝙙𝙚 𝙝𝙚𝙖𝙡𝙩𝙝.
