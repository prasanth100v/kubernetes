...
### 🖥️ Compute
 - 🖥️ **Amazon EC2** – Worker nodes for Kubernetes
 - 📈 **EC2 Auto Scaling Groups** – Automatically scale worker nodes based on demand

### 🔐 Security & Identity
 - 🔑 **AWS IAM** – Authentication and authorization
 - 🛡️ **IAM Roles for Service Accounts (IRSA)** – Fine-grained pod-level permissions
...
### 🌐 Networking
 ...
 - ⚖️ **ALB / NLB** – Load balancing for Kubernetes Services and Ingress
...
### 🗄️ Storage & Databases
 - 🗄️ **Amazon RDS / Amazon Aurora** – Managed databases for stateful workloads
...
### 🔄 Auto Scaling
 ...
 - ⚙️ **EC2 Auto Scaling** – Infrastructure-level scaling
...
A production-grade Kubernetes cluster on AWS typically includes:
 ...
 - 🖥️ EC2 or Fargate for compute
 - 🔐 IAM, KMS, and Secrets Manager for security
 - ⚖️ ALB/NLB for traffic management
 - 🗄️ RDS/S3 for data storage
