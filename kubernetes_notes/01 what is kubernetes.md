...
- 🔄 Kubernetes acts as a `self-healing system`:
  - ♻️ Automatically restarts failed containers
  - 🔁 Reschedules dead pods
  - 🛠️ Replaces unhealthy nodes
...
- ☁️ Cloud platforms like **AWS**, **Azure**, and **GCP**
...
- ⚖️ Traffic is `load-balanced` between pods automatically.
