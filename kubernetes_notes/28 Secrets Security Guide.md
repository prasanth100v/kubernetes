...
### 🔑☁️ Encryption at Rest (Amazon EKS)
...
## 🧠⚙️ Self‑Managed Clusters (kubeadm)
Encryption is **NOT enabled by default**. You must manually configure:
...
Secrets are stored as: `base64 encoded key-value pairs`
...
## 1️⃣🌿 Option 1 --- Environment Variables
...
Never commit **plain Secrets** to Git. Instead use:
...
# 🧰🛠️ Popular Secret Management Tools
### 🔐 HashiCorp Vault
