 ...
 * ⚙️ `Worker Nodes` run the containerized applications.
...
- 📥 Handles requests from:
   - 👤 Users
   - 🛠️ Tools (`kubectl`, `dashboards`, `CI/CD tools`)
...
- ⚙️ Uses **Raft consensus algorithm**
...
Supports:
 - ⚖️ Load Balancers (`AWS ELB`, Azure LB, GCP LB)
...
4. ▶️ Starts container via runtime
...
4. ⚖️ Load-balances traffic across `healthy Pods`
...
3. ▶️ Starts and manages the container
