...
| ⚙️ **Worker Node**                 | Execution machine                | Runs application containers                            |
...
| ☁️ **LoadBalancer**                | Cloud service                    | Exposes app with public IP                             |
| 🌐 **Ingress**                     | HTTP routing                     | Routes traffic using domain/path                       |
| 🚪 **Ingress Controller**          | Traffic handler                  | Implements ingress rules                               |
| ⚙️ **ConfigMap**                   | Non-secret config                | Stores env variables, configs                          |
...
| ⚠️ **Taint**                       | Node restriction                 | Prevents pod scheduling                                |
...
| ❤️ **Probe (Liveness)**            | Health check                     | Restarts unhealthy pod                                 |
...
| ✏️ **Mutating Webhook**            | Modifies requests     | Adds labels automatically              |
...
| ⚠️ **Eviction**                    | Pod removal           | Due to memory/disk pressure            |
...
| ⚠️ **Node Pressure**               | Resource shortage     | Memory, disk, PID pressure             |
...
| Term                                    | What It Is                | Simple Explanation / Real Use              |
| --------------------------------------- | ------------------------- | ------------------------------------------ |
| ☁️ **Amazon Web Services**                 | Cloud platform            | Provides infrastructure & managed services |
...
| ⚙️ **Managed Node Group**                  | AWS-managed nodes         | AWS handles upgrades                       |
